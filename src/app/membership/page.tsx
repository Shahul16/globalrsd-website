...
export const metadata: Metadata = {
  title: "Membership",
  description:
    "Join GIRSD from £49/year. Student, Academic and Industry tiers with a 30% discount on all conference tickets, course discounts, mentoring and members-only briefings.",
        ...
        <div className="mx-auto max-w-7xl px-4">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 leading-relaxed text-slate-600">
              Our Scientific Committee is the heart of GIRSD&apos;s academic
            ...
            <Reveal>
              <div className="card h-full p-8">
                ...
                <ul className="mt-5 space-y-3 text-sm leading-relaxed text-slate-600">
                  ...
                  <li className="flex gap-2"><span aria-hidden="true" className="text-gold-dark">✓</span> 20% discount on GIRSD events</li>
          ...
          <Reveal className="grid items-center gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 leading-relaxed text-slate-300">
                ...
                academics and skilled professionals. GIRSD offers conference
            ...
            <div className="rounded-lg border border-gold/40 bg-white/5 p-8 text-center">
              <p className="font-display text-2xl font-bold text-gold">Partner with GIRSD</p>
