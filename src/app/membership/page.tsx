...
export const metadata: Metadata = {
  title: "Membership",
  description:
    "Join Globalrsd from £49/year. Student, Academic and Industry tiers with a 20% discount on all conference tickets, course discounts, mentoring and members-only briefings.",
  ...
  return (
    <>
      <PageHero
        ...
        intro="Three tiers, one community. Every member saves 20% on conference tickets and 10% on courses — plus mentoring, briefings and recognition."
      />
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        ...
        <Reveal>
          <p className="mx-auto mt-10 max-w-2xl text-center text-sm text-slate-500">
            ...
            any time from your dashboard. The 20% conference discount is applied
