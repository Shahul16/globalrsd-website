...
export default function AboutPage() {
  return (
    <>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16">
        <Reveal>
          <h2 className="flourish font-display text-3xl font-bold">Founder&apos;s Profile</h2>
          <div className="card mt-8 p-8 sm:flex sm:gap-8">
            <div
              aria-hidden="true"
              className="mx-auto mb-6 flex h-28 w-28 shrink-0 items-center justify-center rounded-full bg-navy font-display text-3xl font-bold text-gold sm:mx-0 sm:mb-0"
            >
              {founder.name
                .split(" ")
                .map((w) => w[0])
            ...
            <div>
              ...
              <p className="mt-4 leading-relaxed">{founder.bio}</p>
            </div>
          </div>
        </Reveal>
      </section>
          ...
          <div className="card flex flex-wrap items-center gap-6 border-l-4 border-l-gold p-8">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 leading-relaxed">
                We are proud to be an approved CPD (Continuing Professional
                Development) provider, ensuring our events and courses meet the
