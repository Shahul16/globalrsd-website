...
export const metadata: Metadata = {
  title: "Events",
  description:
    "Explore GIRSD's research conferences, skills development workshops and global education summits. Delegate registration and tickets from £99.",
  ...
  return (
    <>
      <PageHero
        ...
        intro="Register as a delegate, present your research or exhibit your organisation. GIRSD members save 30% on every ticket."
      />
