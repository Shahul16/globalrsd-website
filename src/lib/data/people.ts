...
export const committees: { name: string; description: string; members: Person[] }[] = [
  {
    ...
    description:
      "Oversees peer review standards, conference programmes and publication partnerships across all Globalrsd research events.",
    members: [
  ...
  },
  {
    ...
    description:
      "Guides Globalrsd's global strategy, regional partnerships and the Global Education programme.",
    members: [
